---
post_title: DC/OS overlay: An IP-per-Container solution for DC/OS
nav_title: overlay
menu_order: 5
---
...
![Agent configuration for containers running on MesosContainerizer and Docker once the VxLAN has been configured.](./overlay-files/ip-per-container_mesos_dcos.001)
...
![Software architecture for DC/OS overlay control plane.](./overlay-files/Figure2overlaydesigndoc)
