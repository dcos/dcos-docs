...
![Agent configuration for containers running on MesosContainerizer and Docker once the VxLAN has been configured.](path goes here)
...
![Software architecture for DC/OS overlay control plane.](path goes here)
