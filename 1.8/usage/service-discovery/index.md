...
DC/OS provides a number of tools out of the box ranging from basic network connectivity between containers, to more advanced network features such as load balancing and service discovery. Here's an overview of the options, with some general guidelines on what to use in which situations.
...
| [Third Party Solutions][6] | Service Discovery solutions provided by the DC/OS Community. | Intended for more specific use cases. |
