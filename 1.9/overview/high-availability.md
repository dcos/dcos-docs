 ...
 * Using an HA load balancer like [Marathon-LB](/docs/1.9/networking/marathon-lb/), or the internal [Layer 4 load balancer](/docs/1.9/networking/load-balancing-vips/).
