...
## The DC/OS CLI
You can [install](/docs/1.9/usage/cli/install/) the DC/OS Command Line Interface (CLI) locally on your machine. The DC/OS CLI communicates with the DC/OS cluster, running either on-premise or with a cloud provider.
...
[1]: /docs/1.9/usage/developing-services/service-requirements-spec/
