...
Yes. For more information, see [this document](/docs/1.9/administration/installing/high-availability-setup/).
...
For more information, see the Design: Installation [documentation](/docs/overview/design/).
...
[1]: /docs/1.9/usage/service-discovery/load-balancing-vips/
...
[5]: /docs/1.9/administration/installing/custom/convert-agent-type/
