...
- Marathon provides a `health` member of the task resource via the [REST API](/docs/1.9/deploying-services/marathon-api/) that you can add to your service definition.
