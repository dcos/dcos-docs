 ...
 * Using an HA load balancer like [Marathon-LB](/docs/1.9/usage/service-discovery/marathon-lb/), or the internaly [Layer 4 load balancer](/docs/1.9/usage/service-discovery/load-balancing-vips/).
