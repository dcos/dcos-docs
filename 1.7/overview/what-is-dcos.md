...
One way to make sense of all this complexity is to create a package of the common applications you would like to take advantage of in your datacenter, to simplify deployment and life cyle management. When bundling common applications into deployment packages, you also have many choices of technology you can build on top of, such as databases or messaging services. By bundling the processes and configurations into a single package, you can get started fast and be sure you’re following best practices.
