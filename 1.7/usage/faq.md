...
Yes. For more information, see [this document](/docs/1.7/administration/installing/high-availability-setup/).
...
For more information, see the Design: Installation [documentation](/docs/1.7/overview/design/).
